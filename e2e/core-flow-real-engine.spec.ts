...
test('core flow remains stable with on-device CLIP kNN enabled', async ({ page }) => {
  await page.addInitScript(() => {
    (window as unknown as { __ROCKID_ANALYZER_KIND__?: unknown }).__ROCKID_ANALYZER_KIND__ = 'onDeviceClipKnn';
  });
