...
| `Asphalt Boundary Readout` | `In Progress` | Sprint 47 adds one ambiguous wet-asphalt pressure case near Basalt while preserving non-rock Top-1 behavior. |
