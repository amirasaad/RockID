...
| `E7: Platform Readiness` | Dependencies and local app runtime stay compatible | `In Progress` | [Sprint 7](<sprints/Sprint-07-expo-compatibility-maintenance.md>), [Sprint 14](<sprints/Sprint-14-on-device-inference.md>), [Sprint 28](<sprints/Sprint-28-platform-release-hardening.md>) | Run the aggregate release gate before the next bump |
...
| `E12: Release Stability` | iOS and Android build gates pass before release | `In Progress` | [Sprint 28](<sprints/Sprint-28-platform-release-hardening.md>), [Sprint 31](<sprints/Sprint-31-calibration-release-candidate.md>) | Convert individual green commands into one aggregate gate pass before release |
...
| `Release build stability` | `In Progress` | iOS/Android bundle and native build commands are green; aggregate gate remains the next release-bump proof. |
