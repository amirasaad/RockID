...
| `True Detection Foundation` | `In Progress` | Sprint 39 measures the current real-engine gap, clarifies target taxonomy, and selects one bounded detection experiment. |
