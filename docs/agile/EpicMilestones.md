...
| `E7: Platform Readiness` | Dependencies and local app runtime stay compatible | `In Progress` | [Sprint 7](<sprints/Sprint-07-expo-compatibility-maintenance.md>), [Sprint 14](<sprints/Sprint-14-on-device-inference.md>), [Sprint 28](<sprints/Sprint-28-platform-release-hardening.md>) | Prove iOS/Android release build stability |
...
| `E12: Release Stability` | iOS and Android build gates pass before release | `In Progress` | [Sprint 28](<sprints/Sprint-28-platform-release-hardening.md>), [Sprint 31](<sprints/Sprint-31-calibration-release-candidate.md>) | Run and record full release build gate |
...
| `Release build stability` | `In Progress` | Release gate now requires iOS/Android bundle and native build success before bump. |
