...
| `Basalt Support Index Promotion` | `In Progress` | Sprint 45 re-tests the previously rejected Basalt support candidate now that same-label support no longer collapses confidence. |
