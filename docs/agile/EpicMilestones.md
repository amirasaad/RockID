...
| `Dark Confuser Index Experiment` | `In Progress` | Sprint 40 starts from the gated Sprint 39 baseline and limits the next detection move to one dark-confuser boundary experiment. |
