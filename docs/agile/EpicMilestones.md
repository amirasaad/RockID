...
| `E5: Saved Finds` | Users can save, persist, reopen, delete, and see recent finds | `Done` | [Sprint 3](<sprints/Sprint-03-saved-finds.md>), [Sprint 5](<sprints/Sprint-05-saved-finds-persistence.md>), [Sprint 6](<sprints/Sprint-06-home-recent-finds.md>), [Sprint 17](<sprints/Sprint-17-saved-photos-and-settings.md>) | Add search/filter polish or export only after MVP loop is calm |
