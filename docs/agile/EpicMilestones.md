...
| `Basalt Boundary Readout` | `In Progress` | Sprint 46 measures the S45 support point against the six-sample dark-boundary pack without changing production behavior. |
