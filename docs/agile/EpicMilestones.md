...
| `Same-Label Confidence Policy` | `In Progress` | Sprint 44 promotes same-label-aware margin while keeping thresholds, index data, and result contracts unchanged. |
