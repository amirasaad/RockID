...
| `S21-3` | `Done` | [collection.tsx](<../../../app/(tabs)/collection.tsx>), [collection-view-model.ts](<../../../lib/collection-view-model.ts>), [s19-collection-search-filter.test.ts](<../../../__tests__/s19-collection-search-filter.test.ts>) | Empty states include a clear recovery action |
