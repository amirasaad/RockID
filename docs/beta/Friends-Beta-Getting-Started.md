...
- Run analysis and read result confidence/uncertainty copy.
- Save a result and reopen it from Collection.
- Reanalyze from a saved item.
...
- Core flow completes without blocker crashes.
- Low-confidence messaging is understandable.
- You can finish save/reopen/reanalyze without losing context.
